...
from .routers import auth, posts, comments, likes, subscriptions, notifications, dashboard
...
# Serves the Chart.js dashboard page's JS/CSS assets (if split out later).
