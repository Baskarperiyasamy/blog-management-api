...
def get_post(post_id: int, db: Session = Depends(get_db)):
    ...
    # View tracking: every time a post is fetched, log a view row. This is
    # what feeds the "Total post views" stat and view charts on the
    # /user/dashboard endpoint.
    db.add(models.PostView(post_id=post.id))
    db.commit()
